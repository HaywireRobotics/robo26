...
public class ButtonMappings {
    ...
    public static String manipulatorIntakeSpin = "y";

    public static String manipulatorShooterSpin = "b";
    // This is really dangerous to trigger. It spins the motor backward to lock it. DO NOT USE WITHOUT REASON
